      ...
      <div className="flex flex-col md:flex-row items-center gap-3 sm:gap-4">
        ...
        <div className="flex items-center gap-3 w-full md:w-auto justify-between md:justify-start">
          ...
          <div className="flex items-center gap-1 bg-zinc-100 dark:bg-zinc-800/80 px-2.5 py-1.5 rounded-xl border border-zinc-200/60 dark:border-zinc-700/60">
            ...
            >
              <option value={1} className="bg-white dark:bg-zinc-900">1x</option>
              <option value={10} className="bg-white dark:bg-zinc-900">10x</option>
              <option value={30} className="bg-white dark:bg-zinc-900">30x</option>
              <option value={60} className="bg-white dark:bg-zinc-900">60x</option>
            </select>
          </div>
        </div>
