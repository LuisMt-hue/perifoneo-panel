  ...
  return (
    ...
    >
      <table className="w-full text-xs text-left border-collapse">
        <thead className="bg-zinc-50/90 dark:bg-zinc-950/60 backdrop-blur-sm border-b border-zinc-200/80 dark:border-zinc-800/80 text-zinc-500 dark:text-zinc-400 font-semibold text-2xs uppercase tracking-wider select-none">
        ...
        <tbody className="divide-y divide-zinc-100 dark:divide-zinc-800/60">
          {estaCargando ? (
            <tr>
              <td colSpan={colDef.length || 1} className="px-4 py-16 text-center">
            ...
            <tr>
              <td colSpan={colDef.length || 1} className="px-4 py-14 text-center">
                <div className="flex flex-col items-center justify-center gap-2 text-zinc-400 dark:text-zinc-500">
                  <div className="w-10 h-10 rounded-full bg-zinc-100 dark:bg-zinc-800/80 flex items-center justify-center text-zinc-400 dark:text-zinc-500">
                    <SearchX size={20} />
                  </div>
