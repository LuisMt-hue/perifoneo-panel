...
import type { PuntoRecorrido, Sector } from '../../types/perifoneo.types';
  ...
  const puntos: PuntoRecorrido[] = useMemo(() => {
    return puntosRaw.map((pt) => {
      ...
      return {
        ...
        lat: pt.latitude,
        lon: pt.longitude,
        velocidad_kmh: Math.round((pt.speed || 0) * 1.852),
    ...
    return [
      {
        ...
        color: g.attributes?.color || '#155BD0',
      },
    ];
        ...
        <div className="flex justify-between items-center flex-wrap gap-3">
          <div className="flex items-center gap-3">
            <button
              ...
              className="size-9 rounded-[21px] flex items-center justify-center bg-white dark:bg-zinc-900 border border-zinc-200/80 dark:border-zinc-800 text-zinc-600 dark:text-zinc-400 hover:text-zinc-900 dark:hover:text-zinc-100 hover:bg-zinc-50 dark:hover:bg-zinc-800 transition-all cursor-pointer shadow-xs focus:outline-none focus:ring-2 focus:ring-[#155BD0]"
          ...
          <div className="flex items-center gap-2.5 flex-wrap">
            ...
            <button
              ...
              className="flex items-center gap-1.5 px-3.5 py-2 bg-white dark:bg-zinc-900 hover:bg-zinc-50 dark:hover:bg-zinc-800 text-zinc-700 dark:text-zinc-300 border border-zinc-200/80 dark:border-zinc-800 rounded-[21px] text-xs font-semibold shadow-xs transition-all cursor-pointer disabled:opacity-50 focus:outline-none focus:ring-2 focus:ring-[#155BD0]"
            ...
            <button
              ...
              className="flex items-center gap-1.5 px-3.5 py-2 bg-white dark:bg-zinc-900 hover:bg-zinc-50 dark:hover:bg-zinc-800 text-zinc-700 dark:text-zinc-300 border border-zinc-200/80 dark:border-zinc-800 rounded-[21px] text-xs font-semibold shadow-xs transition-all cursor-pointer no-print focus:outline-none focus:ring-2 focus:ring-[#155BD0]"
