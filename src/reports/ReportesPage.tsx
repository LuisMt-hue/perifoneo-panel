...
import type {
  ResumenPerifoneador,
  ResumenSector,
} from '../shared/types/perifoneo.types';

type TabTipo = 'perifoneadores' | 'sectores';

/**
 * Constantes de umbrales para indicadores de cumplimiento (%)
 */
export const PERCENTAGE_HIGH_THRESHOLD = 80;
export const PERCENTAGE_MEDIUM_THRESHOLD = 50;
  ...
  const columnsP: ColumnDef<ResumenPerifoneador, unknown>[] = [
    ...
    },
    {
      ...
      cell: (info) => {
        ...
        const colorClass =
          val >= PERCENTAGE_HIGH_THRESHOLD
            ? 'bg-emerald-500/10 text-emerald-600 dark:text-emerald-400 border-emerald-500/20'
            : val >= PERCENTAGE_MEDIUM_THRESHOLD
